        ...
        <div class="flex flex-col md:flex-row h-screen w-screen">
            <div class="md:w-1/5 h-screen left-0 shadow-2xl" id="sidebar">
                ...
                <div class="flex flex-col mt-12">
                    <div class="flex flex-row justify-between items-center h-10 cursor-pointer  hover:bg-gradient-to-r from-blue-600 to-blue-900">
                    ...
                    <div class=" cursor-pointer">
                        <div class="flex flex-row justify-between items-center h-10 mt-1  hover:bg-gradient-to-r from-blue-600 to-blue-900"
                    ...
                    <div
                        ...
                        <div class="basis-5/6 h-8 w-10 my-4 ml-1 pt-1 items-center">
                            <a href="/emplois_du_temps">
                                <span class="text-[13px] ml-0 text-black-200 font-bold mt-10">
                                    Emplois du Temps
                                </span>
                            </a>
                        </div>
                    ...
                    <div class="flex flex-row justify-between items-center h-10 mt-1 cursor-pointer  hover:bg-gradient-to-r from-blue-600 to-blue-900"
                        ...
                        <div class="basis-1/6 h-8 w-auto my-4 ml-1 pt-1">
                            <span class="text-sm cursor-pointer" id="arrow1">
                                <img src="{{ asset('svgs/solid/chevron-down.svg') }}" height="8" width="8"
                                    alt="Logout" class="ml-4 mt-2">
                            </span>
                        </div>
            ...
            <div class="md:w-5/6">
                <div class="bg-gradient-to-r from-blue-900 to-indigo-600 h-16 flex justify-between "
                    id="header-content">
                    <!-- Header Content -->
                    <div class="  w-12 my-2 ml-2 mr-2 items-center pt-2 pl-2" onclick="toggleSidebar()">
                ...
                <div class="w-screen h-screen bg-gradient-to-r from-gray-200 to-gray-300 flex flex-col justify-center overflow-y-auto ml-64"
                    id="main-content">
                    @yield('main')
                </div>
